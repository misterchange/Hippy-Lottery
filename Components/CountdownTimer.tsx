...
function countdownTimer() {
 ...
 const { data: expiration,isLoading } = useContractData(contract, "expiration") ; 

 const renderer = ({ hours, minutes, seconds, completed }:Props) =>{
  if (completed) {
    return(
    <div>
      <h2 className='text-white text-xl text-center animate-bounce mb-2'>Ticket sales are now CLOSED for this draw</h2>
